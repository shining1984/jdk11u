...
#ifndef CPU_RISCV32_VM_C1_DEFS_RISCV32_HPP
#define CPU_RISCV32_VM_C1_DEFS_RISCV32_HPP
...
// RISCV32 where floats and doubles are stored in their native form.
enum {
  pd_float_saved_as_double = false
};

#endif // CPU_RISCV32_VM_C1_DEFS_RISCV32_HPP
