...
RISCV32_AS = "<PATH-TO-AS>"
RISCV32_OBJDUMP = "<PATH-TO-OBJDUMP>"
RISCV32_OBJCOPY = "<PATH-TO-OBJCOPY>"
...
with open("riscv32ops.s", "w") as outfile:

    print "// BEGIN  Generated code -- do not edit"
    print "// Generated by riscv32-asmtest.py"
    ...
    generate (ShiftRegOp, ["sll", "srl", "sra"])

    generate (ShiftImmOp, ["slli", "srli", "srai"])
...
subprocess.check_call([RISCV32_AS, "riscv32ops.s", "-o", "riscv32ops.o"])

print
print "/*",
sys.stdout.flush()
subprocess.check_call([RISCV32_OBJDUMP, "-d", "riscv32ops.o"])
print "*/"

subprocess.check_call([RISCV32_OBJCOPY, "-O", "binary", "-j", ".text", "riscv32ops.o", "riscv32ops.bin"])

with open("riscv32ops.bin", "r") as infile:
