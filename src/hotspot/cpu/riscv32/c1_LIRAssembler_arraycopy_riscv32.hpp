...
#ifndef CPU_RISCV32_VM_C1_LIRASSEMBLER_ARRAYCOPY_RISCV32_HPP
#define CPU_RISCV32_VM_C1_LIRASSEMBLER_ARRAYCOPY_RISCV32_HPP
  ...
  void arraycopy_load_args(Register src, Register src_pos, Register length,
                           Register dst, Register dst_pos);
#endif // CPU_RISCV32_VM_C1_LIRASSEMBLER_ARRAYCOPY_RISCV32_HPP
